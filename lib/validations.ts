...
export const AnswerSchema = z.object({
  content: z
    .string()
    .min(100, { message: "Answer has to have at least 100 characters." }),
});
...
export const AIAnswerSchema = z.object({
  question: z
    .string()
    .min(10, { message: "Question has to have at least 10 characters." })
    .max(130, { message: "Question cannot exceed 130 characters." }),
  content: z
    .string()
    .min(30, { message: "Answer has to have more than 30 characters." }),
